...
struct fraction {
    ...
    fraction<numType, denomType>() : numerator(0), denominator(0) {}
    ...
    fraction<numType, denomType> operator +(const fraction<nt, dt> & f) const {
        ...
        return fraction<numType, denomType>(
                    (numerator*f.denominator)+(f.numerator*denominator), denominator*f.denominator);
    }
...
std::ostream & operator <<(std::ostream & stream, fraction<numType, denomType> & fraction) {
